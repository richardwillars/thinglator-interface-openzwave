...
const connect = (zwave, config, commsInterface) => new Promise((resolve, reject) => {
...
const setValue = async (nodeId, classId, instance, index, value, zwave) => {
  zwave.setValue({
...
const setConfig = async (nodeId, instance, index, value, zwave) => {
  zwave.setConfigParam(nodeId, instance, index, value);
};
...
module.exports = async (config, ZWave, commsInterface) => {
  ...
  return {
    ...
    setValue: async (nodeId, classId, instance, index, value) => setValue(nodeId, classId, instance, index, value, zwave),
    setConfig: async (nodeId, instance, index, value) => setConfig(nodeId, instance, index, value, zwave),
  };
};
